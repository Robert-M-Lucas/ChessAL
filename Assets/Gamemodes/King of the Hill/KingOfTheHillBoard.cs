...
namespace Gamemodes.KingOfTheHill
{
    public class Board : NormalChess.Board
    {
        ...
        {
            Initialise(); // Initialise NormalChess board
        }

        // Highlight central 2x2 squares
        public override BoardRenderInfo GetBoardRenderInfo()
        {
            return new BoardRenderInfo(8, new List<V2>(), new List<V2>() { new V2(3, 3), new V2(4, 3), new V2(3, 4), new V2(4, 4) }, true);
        }
    }
